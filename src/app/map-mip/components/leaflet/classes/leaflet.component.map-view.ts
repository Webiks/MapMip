...
export class LeafletMapView {
  ...
  getBounds(): [number, number, number, number] {
    ...
    let saved_bounds: [number, number, number, number] = [
      leaflet_bounds.getNorthWest().lng,
      leaflet_bounds.getNorthWest().lat,
      leaflet_bounds.getSouthEast().lng,
      leaflet_bounds.getSouthEast().lat
    ];
    return saved_bounds;
  }
