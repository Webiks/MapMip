...
import {Router, Params, NavigationExtras, NavigationEnd} from "@angular/router";
...
describe('OpenlayersComponent', () => {
  ...
  describe("map-view", ()=>{
    ...
    it('onLeave should check rotation and go_north value and animate to current rotation if need', () => {
      ...
      map_view.go_north = true;
      map_view.onLeave(observer);
      expect(view.animate).toHaveBeenCalledWith({rotation: Cesium.Math.toRadians(360), duration:500}, map_view.andRotation)
