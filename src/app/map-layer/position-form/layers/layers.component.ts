...
export class LayersComponent implements OnInit, OnChanges {
  ...
  public examples = [
    ...
    {name: 'Applicative light', layer_obj: {source: 'mapbox',url: 'https://api.mapbox.com/styles/v1/', mapid: "idanbarak/ciy1n4ktd00cy2sn0qv3f2ogy/tiles/256", access_token:'pk.eyJ1IjoiaWRhbmJhcmFrIiwiYSI6ImNpdmptNWVrZzAwOTkydGw1NmIxcHM2ZnoifQ.FZxE5OXjfpd6I3fuimotRw'}},
    {name: 'Applicative Dark', layer_obj: {source: 'mapbox',url: 'https://api.mapbox.com/styles/v1/', mapid: "idanbarak/ciy1n0v3400ef2sqde5a354fo/tiles/256", access_token:'pk.eyJ1IjoiaWRhbmJhcmFrIiwiYSI6ImNpdmptNWVrZzAwOTkydGw1NmIxcHM2ZnoifQ.FZxE5OXjfpd6I3fuimotRw'}},
